...
| **llm_agents**（E60 LLM委员会） | ⚠️ 观察账本 07-14 起，同宇宙对标 crypto_core | Haiku新闻+Sonnet辩论决策，每日一次<$0.5；2027-01-14 评估；key 已在 ~/.zshenv |
| **ashare_ml**（E61 E47前瞻记录） | ⚠️ 观察账本 07-14 起，HS300 top-50 月频 | 双轨记账（净成本+毛影子）测信号衰减；低佣通道落地即接 E49；需 TUSHARE_TOKEN |
| **etf_trend**（E62 危机保险） | ⚠️ 观察账本 07-14 起，10 ETF 长多趋势 | 33年净Sharpe 0.58/maxDD -9%/危机年全正；纯多头无融券；用户股票偏好对齐，最接近美股实盘的候选 |
...
**E59 zoo因子特征扩展(4/360过预筛但OOS更差-0.45%/年,公共因子库已检验无增量)**、
**E64 广度扩展300→800(月频下无增量且换手+42%,重开须分钟线/新预注册)**
